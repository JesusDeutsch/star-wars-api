...
const Cards = ({character,index}) => {


    const [planetHouse, setPlanetHouse] = useState([]);
...
<div className="bg-yellow-600 grid-cols-2 h-[350px]box-border ">
      ...
      <div className="bg-[#FFFFE0] flex flex-col items-center gap-3 p-2">
        ...
        <h2 className="m-0 p-0 text-lg font-bold">lives in {planetHouse}</h2>
